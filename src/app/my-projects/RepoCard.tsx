...
export default function RepoCard({ repo }: { repo: Repo }) {
  return (
    <article className="border-accent border-2 border flex flex-col">
      ...
      <h3 className="text-xl font-extrabold text-accent mt-2 mb-4">
        {repo.name}
      ...
      <div className="mb-2">
        <h4 className="font-bold text-accent mt-4 mb-2">Technologies:</h4>
      ...
      <footer className="mt-auto pt-4 flex flex-col gap-4 sm:flex-row sm:gap-2 ">
        <Link
          className="inline-block px-4 py-1 rounded-full  border-accent border-2 hover:bg-accent hover:text-white self-start"
